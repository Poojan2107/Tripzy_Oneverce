export default function PassportShareLoading() {
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center p-6">
      ...
      <span className="text-micro font-mono uppercase tracking-[0.2em] text-muted/50 animate-pulse">Loading passport...</span>
    </div>
  );
}
