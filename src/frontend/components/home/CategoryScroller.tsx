        ...
        <div ref={scrollRef} className="flex gap-4 overflow-x-auto pb-4 scrollbar-none scroll-snap-x -mx-6 px-6 sm:-mx-12 sm:px-12 md:-mx-16 md:px-16 max-w-[100vw]">
          {CATEGORIES.map((cat, i) => (
            <motion.button
              ...
              className="snap-card flex-shrink-0 w-64 h-36 relative rounded-2xl overflow-hidden cursor-pointer group text-left"
            ...
            >
              ...
              <motion.div
                className="absolute top-4 right-4 w-7 h-7 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center"
