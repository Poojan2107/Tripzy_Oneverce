      ...
      marker.bindPopup(`
        <div style="font-family: 'Inter', sans-serif; font-size: 11px; min-width: 170px; text-align: left; background-color: transparent; padding: 2px; color: #0E1B26;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #E7DED3; padding-top: 8px; margin-top: 5px;">
            ...
            <button id="popup-btn-${tour.id}" style="background: #0E1B26; color: #FFFDF9; border: none; font-size: 9px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; padding: 6px 12px; border-radius: 9999px; cursor: pointer; min-width: 70px; transition: all 0.2s;">Inspect</button>
          </div>
        </div>
      `, {
        closeButton: false,
