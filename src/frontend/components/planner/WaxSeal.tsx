export default function WaxSeal({ text = "TRIPZY APPROVED", subtext = "ATLAS VIVANT" }) {
  return (
    <div className="absolute -bottom-4 -right-4 w-20 h-20 sm:w-24 sm:h-24 select-none pointer-events-none z-30 animate-stamp-slam drop-shadow-md" style={{ '--stamp-rotation': '-6deg' } as any}>
      <div className="absolute inset-0 rounded-full bg-[#E6355A] border border-[#a01f37] opacity-95 shadow-inner flex items-center justify-center animate-pulse-slow" style={{ transform: 'scale(1.04) rotate(-2deg)' }}>
