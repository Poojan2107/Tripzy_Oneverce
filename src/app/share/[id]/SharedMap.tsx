...
const ItineraryMap = dynamic(() => import('../../../frontend/components/map/ItineraryMap'), { 
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[400px] lg:h-full bg-secondary-surface flex flex-col items-center justify-center animate-pulse border border-border/30">
      <span className="text-micro font-bold text-muted tracking-wider">LOADING MAP ROUTE...</span>
    </div>
  )
});
