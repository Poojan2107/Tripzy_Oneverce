...
export default function AiPlannerView({
        ...
        <div className="pt-28 pb-32 px-6 max-w-md mx-auto min-h-[100dvh] bg-sand flex items-center justify-center">
          <div className="text-center p-8 bg-white border border-warm-gray rounded-3xl shadow-sm space-y-4">
            ...
            <button 
              ...
              className="px-6 py-2.5 rounded-xl bg-night text-white text-xs font-bold uppercase tracking-wider hover:bg-saffron transition-colors cursor-pointer min-h-[44px]"
            >
              Retry
            </button>
            <button 
              onClick={handleReset} 
              className="px-6 py-2.5 rounded-xl border border-warm-gray bg-white text-xs font-bold uppercase tracking-wider text-muted hover:text-night transition-colors cursor-pointer min-h-[44px]"
            >
              Start Over
            </button>
          </div>
              ...
              <div className="flex items-center gap-2.5 shrink-0">
                {!savedId ? (
                  <button
                    onClick={handleSave}
                    disabled={saving}
                    className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gold text-night text-[10px] font-bold uppercase tracking-wider hover:bg-gold/80 transition-all cursor-pointer disabled:opacity-50 shadow-md min-h-[44px]"
                  >
                    <CheckCircle2 className="w-3.5 h-3.5" />
                    {saving ? 'Archiving...' : 'Save to Passport'}
                  </button>
                ) : (
                  <span className="px-4 py-2.5 rounded-xl bg-white/10 text-white text-[10px] font-bold uppercase tracking-wider border border-white/20 flex items-center gap-1.5 min-h-[44px]">
                    <CheckCircle2 className="w-3.5 h-3.5 text-gold" /> Archived
                  </span>
                )}
                <button
                  onClick={handleReset}
                  className="px-4 py-3 rounded-xl border border-white/20 bg-white/5 text-[10px] font-bold uppercase tracking-wider text-white/60 hover:text-white hover:bg-white/10 transition-all cursor-pointer min-h-[44px]"
                >
                  ↺ New Journey
                </button>
              </div>
  ...
  return (
    <div className="pt-6 pb-32 px-4 md:px-6 max-w-7xl mx-auto min-h-[100dvh] bg-sand flex flex-col lg:flex-row gap-8 items-start justify-center select-none">
          ...
          <div className="bg-white rounded-2xl border border-warm-gray p-4 space-y-3">
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <div className="flex-1 w-full">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2.5 rounded-xl border border-warm-gray text-base text-night placeholder:text-muted/30 outline-none focus:border-gold transition-colors bg-sand/30"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="self-end sm:self-center w-11 h-11 rounded-xl border border-warm-gray bg-white hover:bg-sand/40 transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed shrink-0 flex items-center justify-center"
                title="Swap from/to"
              >
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-32 px-3 py-2 rounded-xl border border-warm-gray text-base text-night text-right outline-none focus:border-gold bg-white"
                />
