...
export default function DestinationForm({ state, actions, onSubmit }: DestinationFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/30 backdrop-blur-sm">
      ...
      <div className="relative w-full sm:max-w-2xl bg-warm-white border-l border-warm-gray shadow-elevated h-full flex flex-col p-4 sm:p-6 overflow-y-auto overscroll-behavior-contain">
        ...
        <form onSubmit={onSubmit} className="space-y-4 sm:space-y-5 flex-1 pb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1">
              ...
              <input type="text" required placeholder="e.g. Varanasi" value={state.name} onChange={(e) => actions.setName(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink placeholder:text-stone/50 focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
            <div className="space-y-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <div className="space-y-1">
              ...
              <input type="number" required value={state.price} onChange={(e) => actions.setPrice(Number(e.target.value))} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-mono font-bold text-stone uppercase tracking-[0.25em]">Duration Guide</label>
              <input type="text" value={state.duration} onChange={(e) => actions.setDuration(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-mono font-bold text-stone uppercase tracking-[0.25em]">Difficulty Level</label>
              <select value={state.difficulty} onChange={(e) => actions.setDifficulty(e.target.value as any)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors appearance-none">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                <div key={field.label} className="space-y-1">
                  ...
                  <input type="number" min="0" max="100" value={field.value} onChange={(e) => field.setter(Number(e.target.value))} className="w-full px-3 py-3 sm:py-2 bg-white border border-warm-gray rounded-lg text-xs text-ink text-center font-medium focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1">
              ...
              <input type="text" value={state.bestMonths} onChange={(e) => actions.setBestMonths(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-mono font-bold text-stone uppercase tracking-[0.25em]">Travel Styles (commas)</label>
              <input type="text" value={state.travelStyles} onChange={(e) => actions.setTravelStyles(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1">
              ...
              <input type="text" value={state.activities} onChange={(e) => actions.setActivities(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-mono font-bold text-stone uppercase tracking-[0.25em]">Tags (commas)</label>
              <input type="text" value={state.tags} onChange={(e) => actions.setTags(e.target.value)} className="w-full px-3.5 py-3 sm:py-2.5 bg-white border border-warm-gray rounded-xl text-xs text-ink focus:outline-none focus:border-gold focus-visible:ring-2 focus-visible:ring-gold/40 transition-colors" />
            </div>
          </div>
