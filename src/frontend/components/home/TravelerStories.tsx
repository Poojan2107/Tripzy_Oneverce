...
export default function TravelerStories({ tours, onSelectTour }: TravelerStoriesProps) {
  ...
  return (
    <section className="py-16 md:py-20 bg-background border-t border-border/15 premium-grid">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-16">
        ...
        >
          <span className="text-meta font-mono text-coral block mb-2">chronicles of movement</span>
